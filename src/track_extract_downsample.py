...
def track_cells(vidfile, maskfile, output_path, downsample=1, show_video=False, display_progress=True):
    """
...
def main():
    track_cells('/home/marcus/Desktop/Scipy/Scipy-2020/samples/llo/llo.mp4',
